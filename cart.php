...
if (isset($_POST['product_id'], $_POST['quantity']) && is_numeric($_POST['product_id']) && is_numeric($_POST['quantity'])) {
    ...
    header('location: shop.php?page=cart');
    exit;
}
...
if (isset($_POST['placeorder']) && isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
    header('Location: shop.php?page=placeorder');
    exit;
}
...
if (isset($_POST['paypal']) && $products_in_cart && !empty($products_in_cart)) {
    ...
    $data = array(
        ...
        'upload'        => '1',
        'lc'			=> 'EN',
        'business' 		=> 'abuswani@yahoo.com',
        'cancel_return'	=> 'https://abuswani.com/shop.php?page=cart',
        'notify_url'	=> 'https://abuswani.com/shop.php?page=cart&ipn_listener=paypal',
        'currency_code'	=> 'USD',
        'return'        => 'https://abuswani.com/shop.php?page=placeorder'
    );
    ...
    <form action="shop.php?page=cart" method="post">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="img">
                        <a href="shop.php?page=product&id=<?=$product['id']?>">
                            <img src="admin/images/<?=$product['img']?>" width="50" height="50" alt="<?=$product['name']?>">
                        </a>
                    </td>
                    <td>
                        <a href="shop.php?page=product&id=<?=$product['id']?>"><?=$product['name']?></a>
                        <br>
                        <a href="shop.php?page=cart&remove=<?=$product['id']?>" class="remove">Remove</a>
                    </td>
